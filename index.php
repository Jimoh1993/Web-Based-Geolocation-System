 <?php include('header.php'); ?>
  ...
  <div class="add_place none" id="autorized">
   ...
   <div class="add_place none" id="autorizedreg">
    <div class="place_form register_form">
      <i class="fa fa-times close_window" id="closeaureg"></i>
...
<select>
  ...
  <option> art </option>
        ...
        <label>Department: 
<select>
  <option> select Depatmeent</option>
  <option> Csc </option>
  <option> Chem </option>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="header_promo">
              ...
              <a href="#" class="log_btnreg ">Register</a>
          ...
          <div class="input-group">
            ...
            <div class="input-group-btn btn_cat">
              ...
              <ul class="dropdown-menu dropdown-menu-right place_dd" role="menu">
                ...
                <li><a href="#" class="club"><i class="fa fa-beer"></i>Club</a></li>
                <li><a href="#" class="cafe"><i class="fa fa-cutlery"></i>Cafe</a></li>
...
<div class="sl_descrition">
  ...
  <span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer 
    ...
    <div class="btns"><a href="#" class="btn btn-success">Get started</a></div>
  </div>
</div>
</li>
...
<div class="categori_block container-fluid">
  <div class="fixed_w">
    ...
    <a href="#" class="btn btn-success va">View all places</a>
  </div>
</div>

<!--Map block-->
<div class="map_block container-fluid">
  <div class="map_descr"><span>View full place catalog<a href="#">View all places</a></span></div>
